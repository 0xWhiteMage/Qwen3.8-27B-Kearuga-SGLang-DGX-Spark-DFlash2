...
class DFlashWorkerV2(BaseSpecWorker):
    ...
    def _maybe_build_draft_sampler(self):
        ...
        if self.selector is not None:
            ...
            # Quantized heads are safe when the target's own quant_method supports
            # lm_head projection; this is the pinned-base adaptation of upstream
            # SGLang PR #35496 without importing newer worker APIs.
